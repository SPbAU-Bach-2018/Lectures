...
\begin{enumerate}[label=\Roman*.]
    ...
    График распределения "--- <<колокол>>, $\sigma$ отвечает за его ширину, $a$ -- за местоположение его пика.
...
\begin{theorem}[О классификации]
Пусть $F_\xi(x)$ -- функция распределения произвольной случайной величины $\xi$. Она единственным образом представляется в виде комбинации
\begin{gather*}
F_\xi(x) = \lambda_1 F_1(x) + \lambda_2 F_2(x) + \lambda_3 F_3(x), \\
\lambda_1 + \lambda_2 + \lambda_3 = 1
\end{gather*}
где $F_1, F_2, F_3$ -- функции распределения каких-то дискретной, непрерывной и сингулярной случайной величины соответственно, при этом такое разложение единственно.
\end{theorem}