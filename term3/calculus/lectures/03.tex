...
\begin{theorem}[Замена переменной в кратном интеграле]\label{mult_var_subst}
	$G \subset \R^n$ "--- открыто и измеримо,\\
	$\phi\colon \cl G \ra D \subset \R^n$ биективна, непрерывна и непрерывно дифференцируема на $\cl G$,
	якобиан
	\[
		J_\phi(t) = \det
		\begin{pmatrix}
