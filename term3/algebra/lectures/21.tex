...
Рассмотрим $T_p^q = V^*\otimes \cdots \otimes V^* \otimes V \otimes \cdots \otimes V$\\
$p$ раз повторяется $V^*$ и $q$ раз повторяется $V$\\
Элементы $T_{p}^q(V)$ "--- тензоры валентности $(p, q)$. ($p$ раз ковариантныеь $q$ раз контрвариантные)
...
\begin{Def}
Алгебра($A$) над полем $K$ "--- это алгебраическая  структураб которая является векторным пространством
