...
\begin{theorem}
	$\mathscr A$ "--- ортогональный оператор в $\R^n$.
	Существует ортонормированный базис пространства $\R^n$, в котором матрица $[\mathscr A]$ имеет вид:
	\[ \begin{pmatrix}
...
\begin{gather*}
	|v| = 1 \\
	\mathscr Av = \lambda v \\
	\mathscr A\bar v = \bar \lambda \bar v \\
	|\bar v| = |v| = 1
\end{gather*}
