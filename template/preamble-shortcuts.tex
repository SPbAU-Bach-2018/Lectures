...
\newcommand{\cimg}[1]{\begin{center}\includegraphics[width=0.75\linewidth]{#1}\end{center}}
\newcommand{\rimg}[1]{\begin{wrapfigure}{r}{0.3\linewidth}\includegraphics[width=1.0\linewidth]{#1}\end{wrapfigure}}
